...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //template id: template_xb8ne5c
    //Service id: service_szbw1od
    // public key : g6KurVbgU3IXpmXTE
    emailjs
      .send(
        "service_szbw1od",
        "template_xb8ne5c",
        {
          from_name: form.name,
          to_name: "Chandra Mouli",
          from_email: form.email,
          to_email: "chandramouli.panyam@gmail.com",
    ...
    >
      ...
      >
        ...
        >
          ...
          <label htmlFor='' className='flex flex-col'>
            <span className='tex-white font-medium mb-4'>Your Email</span>
            <input
              type='email'
              name='email'
              value={form.email}
          ...
          <label htmlFor='' className='flex flex-col'>
            <span className='tex-white font-medium mb-4'>Your Message</span>
            <textarea
              rows='7'
              name='message'
              value={form.message}
